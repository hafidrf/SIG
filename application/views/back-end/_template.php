...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="http://sedotcode.blogspot.co.id/2017/03/aplikasi-gis.html" rel="nofollow" class="logo">
          ...
          <span class="logo-lg"><b>SIG</b> Instansi Pemerintahan</span>
        </a>
    </header>
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2016</strong> <a href="<?=base_url() ?>">Sistem Informasi Geografis Instansi Pemerintahan di Kecamatan Masamba, Kabupaten Luwu Utara</a>. All rights
        reserved.
    </footer>
